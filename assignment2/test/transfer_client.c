...
int main(int argc, char *argv[])
{
	...
	char source[500];
	char* file_name = "/home/eamon/Documents/software/systems-software/assignment2/test/clientfiles/file.txt";
	char file_buffer[512];

	char *sourceDir = "/home/eamon/Documents/software/systems-software/assignment2/test/clientfiles/";
	char *sourceFile = argv[1];
	char *destination = argv[2];

	//marketing, offers, sales, promotions
	strcpy(source, sourceDir);
	strcat(source, sourceFile);
	printf("%s\n", source);
